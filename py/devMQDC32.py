...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade not found on Sun Aug 30 15:13:29 2015
#
...
class devFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_bltCtrl = wx.StaticText(self, wx.ID_ANY, _("bltCtrl"), style=wx.ALIGN_CENTER)
        self.combo_bltCtrl = wx.ComboBox(self, wx.ID_ANY, choices=[_("noBLT"), _("CBLT-first"), _("CBLT"), _("CBLT-last"), _("MCST")], style=wx.CB_READONLY)
        ...
        self.label_CH = wx.StaticText(self, wx.ID_ANY, _("Channel with Threshold"), style=wx.ALIGN_CENTER_HORIZONTAL)
    ...
    def __do_layout(self):
        ...
        grid_sizer_32.Add(self.label_bltCtrl, 0, wx.ALL | wx.EXPAND, 1)
        ...
        grid_sizer_3.Add(self.panel_2, 1, 0, 0)
