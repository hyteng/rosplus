...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade not found on Sun Jan  3 21:07:27 2016
#
...
class devFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_SPINCTRL, self.otfCtrl, self.ch00_Th)
        # end wxGlade
    ...
    def otfCtrl(self, event):  # wxGlade: devFrame.<event_handler>
        print "Event handler 'otfCtrl' not implemented!"
        event.Skip()
