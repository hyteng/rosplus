...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade not found on Sat Jul 11 00:02:28 2015
#
...
class devFrame(wx.Frame):
    ...
    def __do_layout(self):
        ...
        grid_sizer_19 = wx.GridSizer(2, 8, 1, 1)
        grid_sizer_21 = wx.GridSizer(1, 2, 0, 0)
        grid_sizer_20 = wx.GridSizer(1, 2, 0, 0)
        sizer_1.Add(self.output0, 2, wx.EXPAND, 0)
        grid_sizer_20.Add(self.label_crateSel, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_20.Add(self.crateSel, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_19.Add(grid_sizer_20, 1, 0, 0)
        grid_sizer_19.Add(self.stepTH, 0, wx.ALL | wx.EXPAND, 1)
        grid_sizer_19.Add(self.clearData, 0, wx.ALL | wx.EXPAND, 1)
        grid_sizer_19.Add(self.label_eventCount, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_19.Add(self.eventCount, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_19.Add(self.countReset, 0, wx.ALL | wx.EXPAND, 1)
        grid_sizer_21.Add(self.label_fclrw, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_21.Add(self.fclrw, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_19.Add(grid_sizer_21, 1, 0, 0)
        grid_sizer_19.Add(self.offLine, 0, wx.ALL | wx.EXPAND, 1)
        grid_sizer_19.Add(self.swComm, 0, wx.ALL | wx.EXPAND, 1)
        grid_sizer_19.Add(self.buffFull, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_19.Add(self.softReset, 0, wx.ALL | wx.EXPAND, 1)
        sizer_1.Add(grid_sizer_19, 1, 0, 0)
        grid_sizer_3.Add(self.ch0L_En, 1, wx.ALL | wx.EXPAND, 0)
        grid_sizer_3.Add(self.ch0L_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_3, 1, wx.ALL | wx.EXPAND, 0)
        grid_sizer_4.Add(self.ch1L_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_4.Add(self.ch1L_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_4, 1, 0, 0)
        grid_sizer_5.Add(self.ch2L_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_5.Add(self.ch2L_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_5, 1, 0, 0)
        grid_sizer_6.Add(self.ch3L_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_6.Add(self.ch3L_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_6, 1, 0, 0)
        grid_sizer_7.Add(self.ch4L_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_7.Add(self.ch4L_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_7, 1, 0, 0)
        grid_sizer_8.Add(self.ch5L_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_8.Add(self.ch5L_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_8, 1, 0, 0)
        grid_sizer_9.Add(self.ch6L_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_9.Add(self.ch6L_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_9, 1, 0, 0)
        grid_sizer_10.Add(self.ch7L_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_10.Add(self.ch7L_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_10, 1, 0, 0)
        grid_sizer_11.Add(self.ch0H_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_11.Add(self.ch0H_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_11, 1, 0, 0)
        grid_sizer_12.Add(self.ch1H_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_12.Add(self.ch1H_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_12, 1, 0, 0)
        grid_sizer_13.Add(self.ch2H_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_13.Add(self.ch2H_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_13, 1, 0, 0)
        grid_sizer_14.Add(self.ch3H_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_14.Add(self.ch3H_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_14, 1, 0, 0)
        grid_sizer_15.Add(self.ch4H_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_15.Add(self.ch4H_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_15, 1, 0, 0)
        grid_sizer_16.Add(self.ch5H_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_16.Add(self.ch5H_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_16, 1, 0, 0)
        grid_sizer_17.Add(self.ch6H_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_17.Add(self.ch6H_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_17, 1, 0, 0)
        grid_sizer_18.Add(self.ch7H_En, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_18.Add(self.ch7H_Th, 0, wx.ALL | wx.EXPAND, 0)
        grid_sizer_2.Add(grid_sizer_18, 1, 0, 0)
