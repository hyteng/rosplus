...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.0 on Sat May  9 16:32:42 2015
#
...
class ctrlFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.output = wx.TextCtrl(self, wx.ID_ANY, _("ctrlMsg"), style=wx.HSCROLL | wx.TE_MULTILINE | wx.TE_READONLY)
        self.input = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.HSCROLL | wx.TE_MULTILINE | wx.TE_PROCESS_ENTER)
        ...
        self.Bind(wx.EVT_TEXT_ENTER, self.sendMsg, self.input)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_1.Add(self.devList, 1, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 1)
        sizer_1.Add(self.output, 3, wx.ALL | wx.EXPAND, 1)
        sizer_1.Add(self.input, 0, wx.ALL | wx.EXPAND, 1)
        grid_sizer_1.Add(self.button_Load, 0, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 1)
        grid_sizer_1.Add(self.button_Conf, 0, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 1)
        grid_sizer_1.Add(self.button_Prep, 0, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 1)
        grid_sizer_1.Add(self.button_Star, 0, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 1)
        ...
        sizer_1.Add(grid_sizer_1, 0, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 1)
